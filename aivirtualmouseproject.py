...
while True:
    ...
    #             autopy.mouse.click(button=autopy.mouse.Button.RIGHT)
        ...
        # Right Click: Thumb and Pinky pinch (others down)
    ...
    ram = psutil.virtual_memory().used / (1024 ** 2)  # in MB
    print(f"CPU: {cpu:.2f}%, RAM Used: {ram:.2f} MB")
    process = psutil.Process(os.getpid())
    ram_used_mb = process.memory_info().rss / (1024 ** 2)  # Resident Set Size
    print(f"Virtual Mouse RAM Usage: {ram_used_mb:.2f} MB")
